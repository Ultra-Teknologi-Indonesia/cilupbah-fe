...
export function ProductCard({
  ...
  return (
    <div
      className={cn(
        // Solid content tile on the glass panel — no per-card backdrop-filter
        // (keeps a big grid fast). Glass *accent* = soft shadow + top rim-light +
    ...
    >
      {/* Rim-light accent — a cheap top-edge gleam (no backdrop-filter). */}
      <div
        aria-hidden
      ...
      <div className="relative aspect-[4/3] w-full overflow-hidden bg-muted/40">
        ...
        <div className="absolute right-2 top-2">
          <ProductStatusBadge
            ...
            // Frosted white chip so the colored status text stays legible over
            // the product photo (the default 12%-tint vanishes on images).
