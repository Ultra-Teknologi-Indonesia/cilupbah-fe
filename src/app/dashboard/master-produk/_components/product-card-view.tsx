...
// Card/grid renderer. It builds its OWN TanStack table instance (so the core
// <DataTable> component is untouched) and reuses the exported toolbar +
// pagination sub-components, then renders the row model as cards.
