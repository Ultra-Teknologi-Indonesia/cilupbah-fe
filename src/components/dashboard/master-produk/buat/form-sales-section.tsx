      ...
      <div className="grid gap-5 md:grid-cols-3">
        <div className="flex flex-col gap-4 rounded-2xl border border-border/60 p-4">
          ...
          <div
            className={cn(
              "flex flex-col gap-4",
              !v.isStored && "pointer-events-none opacity-50",
            )}
          >
            <FormField
              control={control}
        ...
        <div className="flex flex-col gap-4 rounded-2xl border border-border/60 p-4">
          ...
          <div
            className={cn(
              "flex flex-col gap-4",
              !v.isSold && "pointer-events-none opacity-50",
            )}
          >
            <FormField
              control={control}
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    Harga jual default{" "}
                    {v.isSold && <span className="text-destructive">*</span>}
                  </FormLabel>
                  <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    {taxHint(
                      field.value ? salesTax?.rateById[field.value] : undefined,
                      v.sellPrice,
                    )}
                  </FormDescription>
                  <FormMessage />
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Combobox
                      ...
                      value={field.value}
                      onChange={field.onChange}
                      placeholder="Pakai akun default"
                    />
                  </FormControl>
        ...
        <div className="flex flex-col gap-4 rounded-2xl border border-border/60 p-4">
          ...
          <div
            className={cn(
              "flex flex-col gap-4",
              !v.isPurchased && "pointer-events-none opacity-50",
            )}
          >
            <FormField
              control={control}
