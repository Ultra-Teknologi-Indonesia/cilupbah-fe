...
export function LoginScreen() {
  return (
    <main
      ...
      style={{
        backgroundImage:
          "radial-gradient(at 0% 0%, color-mix(in oklch, var(--brand) 7%, transparent) 0px, transparent 55%), radial-gradient(at 100% 100%, color-mix(in oklch, var(--brand) 4%, transparent) 0px, transparent 55%)",
      }}
    >
