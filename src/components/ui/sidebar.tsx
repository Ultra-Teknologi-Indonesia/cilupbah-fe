    ...
    >
      ...
      <motion.div
        ...
        initial={{
          ...
          left:
            collapsible === "offcanvas" && side === "left" && !open
              ? `calc(${SIDEBAR_WIDTH} * -1)`
              : undefined,
          right:
            collapsible === "offcanvas" && side === "right" && !open
              ? `calc(${SIDEBAR_WIDTH} * -1)`
              : undefined,
        }}
        animate={{
