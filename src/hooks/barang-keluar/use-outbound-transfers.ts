...
export function useCreateTransferDraft() {
  ...
  return useMutation({
    ...
    onError: (err) =>
      toast.error(
        (err as { message?: string })?.message || "Gagal membuat draft",
      ),
  });
}
...
export function useAddTransferItem() {
  ...
  return useMutation({
    ...
    onError: (err) =>
      toast.error(
        (err as { message?: string })?.message || "Gagal menambah item",
      ),
  });
}
...
export function useRemoveTransferItem() {
  ...
  return useMutation({
    ...
    onError: (err) =>
      toast.error(
        (err as { message?: string })?.message || "Gagal menghapus item",
      ),
  });
}
...
export function useApproveTransfer() {
  ...
  return useMutation({
    ...
    onError: (err) =>
      toast.error(
        (err as { message?: string })?.message || "Gagal approve transfer",
      ),
  });
}
...
export function useCancelTransfer() {
  ...
  return useMutation({
    ...
    onError: (err) =>
      toast.error(
        (err as { message?: string })?.message || "Gagal membatalkan transfer",
      ),
  });
}
...
export function useMarkTransferPrinted() {
  ...
  return useMutation({
    ...
    onError: (err) =>
      toast.error(
        (err as { message?: string })?.message || "Gagal menandai cetak",
      ),
  });
}
