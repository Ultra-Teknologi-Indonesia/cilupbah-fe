...
export const useStockRevaluations = createListHook(
  ...
  (params: StockRevaluationListParams = {}) =>
    StockRevaluationService.list(params),
);
...
export const useCreateStockRevaluation = createMutationHook({
  mutationFn: (data: StockRevaluationFormData) =>
    StockRevaluationService.create(data),
...
export const useCancelStockRevaluation = createMutationHook({
  ...
  invalidates: (id) => [
    stockRevaluationKeys.lists,
    stockRevaluationKeys.detail(id),
  ],
});
