...
export const STATUS_REGISTRY: Record<Domain, Record<string, StatusMeta>> = {
  ...
  "sales-order": {
    ...
    "ready-to-process": { label: "Pengambilan - Belum Dimulai", variant: "info" },
    "ready-to-pick": { label: "Pengambilan - Siap Diambil", variant: "indigo" },
    "on-picking": { label: "Pengambilan - Sedang Diproses", variant: "indigo" },
    "picking-diproses": { label: "Pengambilan - Sedang Diproses", variant: "indigo" },
    ...
    "packing-diproses": { label: "Pengepakan - Sedang Diproses", variant: "purple" },
